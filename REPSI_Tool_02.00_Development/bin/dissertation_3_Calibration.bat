...
%REPSI_JAVA_HOME%\bin\java -jar lib\repsi-tool.jar %VERBOSE% -mode calibration -obj query -di %DI% -tqp 86201 -prec %PREC% -exalt -des %DES%
%REPSI_JAVA_HOME%\bin\java -jar lib\repsi-tool.jar %VERBOSE% -mode calibration -obj query -di %DI% -tqp 86211 -prec %PREC% -exalt -des %DES%
